    ...
    "$graph": [
        {
            "inputs": [
                ...
                }, 
                {
                    ...
                    "type": "File", 
                    "id": "#AddtoSam.cwl/Molecular_Annotation"
                }, 
                {
                    "inputBinding": {
                        "prefix": "--r2-bam"
                ...
                }, 
                {
                    ...
                    "id": "#AddtoSam.cwl/Tag_Calls"
                }
            ], 
            "requirements": [
                {
                    "dockerPull": "bdgenomics/rhapsody:1.6.1", 
            ...
            "hints": [
                {
                    "class": "https://sevenbridges.com#AWSInstanceType", 
                    "value": "r4.16xlarge"
                }
            ]
        }, 
        ...
        }, 
        {
            "inputs": [
                ...
                }, 
                {
                    ...
                    "id": "#AnnotateR2.cwl/Sample_Tags_Version"
                }
            ], 
            "requirements": [
                {
            ...
            "inputs": [
                {
                    ...
                    "id": "#ClusteringAnalysis.cwl/Data_Table"
                }
            ], 
            "requirements": [
                {
            ...
            "outputs": [
                {
                    ...
                    "id": "#ClusteringAnalysis.cwl/Clustering_Analysis"
                }, 
                {
                    "outputBinding": {
                        "glob": "*.log"
                    ...
                    "type": "File", 
                    "id": "#ClusteringAnalysis.cwl/output"
                }
            ], 
            "baseCommand": [
        ...
        }, 
        {
            "inputs": [
                {
                    "doc": "A fasta file containing the AbSeq barcodes used in the experiment", 
                    "type": [
                        "null", 
                        {
                            "items": "File", 
                ...
                {
                    "https://sevenbridges.com#fileTypes": "fastq.gz, fq.gz", 
                    "type": {
                        "items": "File", 
                        "type": "array"
                    }, 
            ...
            "outputs": [
                ...
                }, 
                {
                    ...
                    "outputSource": "#main/ClusterAnalysis/Clustering_Analysis", 
                    "id": "#main/Clustering_Analysis", 
            ...
            "steps": [
                {
                    ...
                    "scatter": [
                        "#main/AddtoSam/R2_Bam"
                    ], 
                    "in": [
                        {
                            "source": "#main/AnnotateR1/Annotation_R1", 
                            "id": "#main/AddtoSam/Annotation_R1"
                        }, 
                        {
                            "source": "#main/Sparse_to_Dense_Datatable/Data_Tables", 
                            "id": "#main/AddtoSam/Data_Tables"
                        }, 
                        {
                            "source": "#main/GetDataTable/Molecular_Annotation", 
                            "id": "#main/AddtoSam/Molecular_Annotation"
                        }, 
                        {
                            "source": "#main/AnnotateR2/R2_Bam", 
                            "id": "#main/AddtoSam/R2_Bam"
                        }, 
                        {
                            "source": "#main/AnnotateReads/Seq_Metrics", 
                            "id": "#main/AddtoSam/Seq_Metrics"
                        }, 
                        {
                            "source": "#main/GetDataTable/Tag_Calls", 
                            "id": "#main/AddtoSam/Tag_Calls"
                        }
                    ], 
                    "run": "#AddtoSam.cwl", 
                    "id": "#main/AddtoSam", 
                    "out": [
                        "#main/AddtoSam/Annotated_Bam", 
                        "#main/AddtoSam/output"
                    ]
                }, 
                {
                    "scatter": [
                ...
                }, 
                {
                    ...
                    "in": [
                        {
                            "source": "#main/Internal_Settings/Extra_Seqs", 
                        ...
                        }, 
                        {
                            ...
                            "id": "#main/AnnotateR2/Sample_Tags_Version"
                        }
                    ], 
                    "run": "#AnnotateR2.cwl", 
                    "id": "#main/AnnotateR2", 
                    ...
                    "in": [
                        {
                            ...
                            "id": "#main/ClusterAnalysis/Data_Table"
                        }
                    ], 
                    "run": "#ClusteringAnalysis.cwl", 
                    "id": "#main/ClusterAnalysis", 
                    "out": [
                        "#main/ClusterAnalysis/Clustering_Analysis", 
                        "#main/ClusterAnalysis/output"
                    ]
                }, 
                {
                ...
                }, 
                {
                    "in": [
                        {
                            "source": "#main/AddtoSam/Annotated_Bam", 
                ...
                }, 
                {
                    ...
                    "in": [
                        ...
                        {
                            "source": "#main/GetDataTable/UMI_Adjusted_Stats", 
